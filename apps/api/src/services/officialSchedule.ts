...
export const OFFICIAL_SCHEDULE:OfficialScheduleTemplate[]=[
  ...
  slot(25,'PUBLIC','ประชาชน','QF','A-C','2026-09-19','10:00','10:40',label('อันดับ 1 สาย A'),label('อันดับ 2 สาย C')),
  slot(26,'PUBLIC','ประชาชน','QF','A-C','2026-09-19','10:40','11:20',label('อันดับ 1 สาย C'),label('อันดับ 2 สาย A')),
  slot(27,'PUBLIC','ประชาชน','QF','B-D','2026-09-19','11:20','12:00',label('อันดับ 1 สาย B'),label('อันดับ 2 สาย D')),
  slot(28,'PUBLIC','ประชาชน','QF','B-D','2026-09-19','13:00','13:50',label('อันดับ 1 สาย D'),label('อันดับ 2 สาย B')),
  slot(29,'SENIOR40','อาวุโส 40+','QF','A-C','2026-09-19','13:50','14:40',label('อันดับ 1 สาย A'),label('อันดับ 2 สาย C')),
  slot(30,'SENIOR40','อาวุโส 40+','QF','A-C','2026-09-19','14:40','15:30',label('อันดับ 1 สาย C'),label('อันดับ 2 สาย A')),
  slot(31,'SENIOR40','อาวุโส 40+','QF','B-D','2026-09-19','15:30','16:20',label('อันดับ 1 สาย B'),label('อันดับ 2 สาย D')),
  slot(32,'SENIOR40','อาวุโส 40+','QF','B-D','2026-09-19','16:20','17:10',label('อันดับ 1 สาย D'),label('อันดับ 2 สาย B')),
