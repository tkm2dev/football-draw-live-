...
export const useTournamentStore=defineStore('tournament',{
  ...
  actions:{
    ...
    async generateKnockout(){await this.post('/api/knockout/generate',{divisionKey:this.divisionKey});await Promise.all([this.loadTournament(),this.loadOfficialSchedule()])},
    async advanceKnockout(){await this.post('/api/knockout/advance',{divisionKey:this.divisionKey});await Promise.all([this.loadTournament(),this.loadOfficialSchedule()])}
  }
})
