...
<template>
  <div class="page standings-page"><TopBar/><main class="content standings-content">
    <header class="standings-head"><div><div class="eyebrow">OFFICIAL GROUP TABLES</div><h1>ตารางคะแนนการแข่งขัน</h1><p>อัปเดตอัตโนมัติจากผลการแข่งขันที่ยืนยันว่าจบแล้ว เลือกชื่อทีมเพื่อดูรายละเอียด</p></div><div class="standings-actions"><label class="division-select"><span>รุ่นการแข่งขัน</span><select v-model="s.divisionKey" :disabled="busy" @change="changeDivision"><option value="PUBLIC">รุ่นประชาชน</option><option value="SENIOR40">รุ่นอาวุโส 40+</option></select></label></div></header>
